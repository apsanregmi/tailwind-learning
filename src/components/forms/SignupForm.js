  ...
  const onFinish = async (values) => {
    try {
      ...
      if (response.ok) {
        ...
        const redirectLink =
          redirectParam ||
          'https://zsjdvui4dac9zhpf.public.blob.vercel-storage.com/Transforming%20Retail%20with%20cloudproAI%20a%20case%20study-K0uzLePL5UdKtC1MlIkZiksokioqCG.pdf';
  ...
  return (
    <div className={styles.signupContainer}>
      ...
      <Form form={form} onFinish={onFinish} layout="vertical">
        ...
        <Form.Item className={styles.formItem} name="subscribeNewsletter" valuePropName="checked">
        ...
        <Form.Item className={styles.formItem} label="Follow our LinkedIn Page">
          <a
            href="https://www.linkedin.com/company/cloudproai/mycompany/"
            target="_blank"
        ...
        <Form.Item className={styles.formItem}>
          ...
          <span className={styles.agreeText}>
            By submitting, I agree to the processing of my personal data by Cloud Pro AI in
            accordance with our{' '}
