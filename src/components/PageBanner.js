      ...
      <div className="md:container md:mx-28 md:py-24 px-2 md:px-6 flex md:w-1/2 w-full md:pt-3/4 ">
        <div className="max-w-2xl mx-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 pt-10">
            ...
            <li className=" grid sm:block sm:flex-row w-auto justify-center ">
              <a className="hover:text-gray-200  w-fit " href="/contact">
                <button className="bg-[#EDFF6C]  hover:bg-yellow-700 text-black font-bold py-2 px-4 rounded">
                  Contact Us
                </button>
              </a>
            </li>
            <li className="w-auto justify-center ">
              <p className="font-normal text-white text-xl flex-col pt-14  cursor-pointer hover:underline">
                Book a Free Call
